...
import { builders as builders$1 } from "prettier/doc";
...
declare function canAttachComment(node: SyntaxNode, ancestors: SyntaxNode[]): boolean;
...
declare const _default: {
  ...
  printers: {
    java: {
      print(path: import("prettier").AstPath<SyntaxNode>, options: import("prettier").ParserOptions<SyntaxNode>, print: (selector?: string | number | import("prettier").AstPath<SyntaxNode> | (string | number)[] | undefined, args?: unknown) => import("prettier").Doc, args: unknown): import("prettier/doc.js").builders.Doc;
      embed(path: import("prettier").AstPath<any>): ((textToDoc: (text: string, options: import("prettier").Options) => Promise<import("prettier").Doc>) => Promise<import("prettier/doc.js").builders.Doc[]>) | null;
      hasPrettierIgnore(path: import("prettier").AstPath<SyntaxNode>): boolean;
      ...
      printComment(commentPath: import("prettier").AstPath<SyntaxNode>): string | import("prettier/doc.js").builders.Doc[];
